...
private:
	...
	void UpdatePhysics(float &timeElapsed);
...
protected:
	...
	void FocusAndCenterCameraOnEntity(GameObject* Entity);
...
private:
	...
	void RMB_Event_Button_DestroyObject() { GameWorld->DestroyGameObject(RMB_Event_GO); }
